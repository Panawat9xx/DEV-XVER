...
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$y                    DEV : ORGAEN $wh"
echo -e "$y           Premium Auto Script By Orgaen $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo ""
echo -e "$y SSH & OpenVPN $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$yy 1$y.สร้างบัญชี SSH & OpenVPN"
echo -e "$yy 2$y.สร้างบัญชีทดลอง SSH & OpenVPN (1 วัน)"
echo -e "$yy 3$y.ต่ออายุบัญชี SSH & OpenVPN Account"
echo -e "$yy 4$y.เช็คผู้ใช้งานอยู่ SSH & OpenVPN"
echo -e "$yy 5$y.รายชื่อบัญชีทั้งหมด SSH & OpenVPN"
echo -e "$yy 6$y.ลบบัญชี SSH & OpenVpn Account"
echo -e "$yy 7$y.ลบบัญชีที่หมดอายุแล้ว SSH & OpenVPN"
...
echo -e "$y SYSTEM $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$yy 49$y.เพื่ม Sub โดเมน"
echo -e "$yy 50$y.เปลี่ยนพอตระบบ"
echo -e "$yy 51$y.Autobackup Data VPS"
echo -e "$yy 52$y.สำรองข้อมูลเซิฟเวอร์"
echo -e "$yy 53$y.คืนค่าสำรองข้อมูลเซิฟเวอร์"
echo -e "$yy 54$y.Webmin Menu"
echo -e "$yy 55$y.จำกัดความเร็วอินเตอร์เน็ต"
echo -e "$yy 56$y.เช็คการใช้งานแรม"
echo -e "$yy 57$y.รีบูทเซิฟเวอร์"
echo -e "$yy 58$y.ทดสอบความเร็วอินเตอร์เน็ต"
echo -e "$yy 59$y.แสดงข้อมูลระบบ"
echo -e "$yy 60$y.Info Script Auto Install"
echo -e "$y-------------------------------------------------------------$wh"
echo -e ""
read -p "กรุณาเลือกเมนู [ 1 - 60 ] : " menu
echo -e ""
case $menu in
1)
addssh
